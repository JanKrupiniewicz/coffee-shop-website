...
export default function LocationItem({ location }: { location: Location }) {
  return (
    <div className="flex flex-col border-b border-gray-400 p-2 lg:flex-row lg:border-none">
      ...
      <div className="m-5">
        <h1 className="text-2xl uppercase fraunces">{location.name}</h1>
        <div className="text-lg space-y-3 lato">
          <div>
            <p className="text-xl font-bold">A d d r e s s</p>
            <p>{location.address1}</p>
            <p>{location.address2}</p>
          </div>
          <div>
            <p className="text-xl font-bold">P h o n e</p>
            <p>{location.phone}</p>
          </div>
          <div>
            <p className="text-xl font-bold">H o u r s</p>
